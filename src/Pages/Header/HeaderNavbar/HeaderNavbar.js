...
const HeaderNavbar = () => {
    ...
    // </>
    return (
        <nav className="navbarColor w-full nav-border  md:border-0 md:static">
                    ...
                    {user?.uid ?
                        <div className='flex '>
                            ...
                            <a
                                ...
                                href="/download"
                            ><button class="block rounded-full bg-white px-4 py-2 text-sm font-medium hover:bg-transparent" onClick={handelLogout}>Logout</button></a>
                        </div> :
                        <div className='flex'>
                             <a 
                                className="inline-block rounded-full btn-bg-color  p-[2px] hover:text-white focus:outline-none focus:ring active:text-opacity-75"
                                href="/download"
                            ><NavLink to='/login'  className="block rounded-full bg-white px-4 py-2 text-sm font-medium hover:bg-transparent text-color" onClick={handelLogout}>Login</NavLink></a>
                              <a 
                                ...
                                href="/download"
                            ><NavLink to='/SignUp' className="block rounded-full text-color px-4 py-2 text-sm font-medium hover:bg-transparent" onClick={handelLogout}>SignUp</NavLink></a>
                        </div>
                    }
                </div>
            </div>
