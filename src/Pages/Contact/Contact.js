                        ...
                        <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        name='full_name' id="name" type="text"
                                        required
                                ...
                                <div>
                                    ...
                                    <textarea required name="message"  id="message" className="w-full mt-2 h-36 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"></textarea>
                                </div>
                                <button
