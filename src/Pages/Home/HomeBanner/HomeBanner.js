            ...
            <section>
                <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-center overflow-hidden md:flex md:px-8">
                    <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
                        <h2 className="text-4xl bannertext-color font-extrabold md:text-5xl mt-10 lg:mt-0">
                        ...
                        <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                            <Link to="/allProduct" className="flex items-center justify-center gap-x-2 py-2 px-4 bannertext-color hover:text-gray-500 font-medium duration-150 active:text-color2 border-color rounded-lg md:inline-flex">
                                let shop
